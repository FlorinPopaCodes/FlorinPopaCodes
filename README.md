...
- [ingredient-parser-hybrid](https://github.com/FlorinPopaCodes/ingredient-parser-hybrid) - hybrid ingredient parser using CRF with LLM fallback and embedding-based normalization
- [recipe-scraper](https://github.com/FlorinPopaCodes/recipe-scraper) - ethical web scraper for allrecipes.com recipes
...
- [Time Value Calculator](https://github.com/FlorinPopaCodes/time-value-calculator) - calculates how much to spend to save time

## Toys
- [Advent of Code](https://github.com/FlorinPopaCodes/advent-of-code) - Advent of Code solutions in Ruby
...
- [HTTP Server in Go](https://github.com/FlorinPopaCodes/codecrafters-http-server-go) - build your own HTTP server in Go using [CodeCrafters](https://codecrafters.io/)

## Informal History

- self-taught, started in kindergarten, coding for 30+ years
- failed startup during highschool with two others for a car classified ads platform
- started working professionally since the 2nd year of college. first month salary was 100$
- worked in a web agency where I had to do everything except design and sales
- moved to startup accelerator where I led the team that delivered a project leading to a company funded
- got the opportunity to be paid to learn Ruby and work at one of the best companies in Boston, but company got acquired by PE and I was forced to find something better
